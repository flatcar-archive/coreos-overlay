...
if [[ ${PV} = *9999* ]]; then
	...
	DOCKER_GITCOMMIT="229340e" # v19.03.12
...
RDEPEND="
	...
	~app-emulation/docker-runc-1.0.0_rc91[apparmor?,seccomp?]
...
src_compile() {
	...
	# Imitating https://github.com/docker/docker-ce/blob/v19.03.12/components/cli/scripts/build/.variables#L7
